        ...
        return assignments
            .map((assignment) => {
                ...
                return {
                    ...
                    programName: firstText(assignment.programName, assignment.snapshot?.programName, application?.programName),
